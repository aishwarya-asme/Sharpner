  ...
  return (
    <div className='w-[20%] bg-white shadow-lg rounded-xl h-[620px] absolute top-5 left-2/3 ml-16'>
      <div className='flex justify-between p-6 font-semibold text-xl'>
        ...
        className='border-black border-solid border-2 px-3 rounded-lg'>X</button>
      </div>
      ...
      <div className='text-center'>
        ...
        className='px-4 py-2 font-semibold text-lg text-white bg-blue-700 rounded-lg'>Place Order</button>
      </div>
    </div>
  )
}
